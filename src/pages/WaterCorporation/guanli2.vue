                ...
                <Widget title="<h5>项目节点</h5>" customHeader settings close>
                    ...
                    <div id="table">
                        <el-table :data="current" style="width: 100%"  @selection-change="handleSelectionChange">
                            ...
                            <el-table-column prop="xmmc" label="收入" >

                            </el-table-column>
                            <el-table-column prop="time" label="支出">

                            </el-table-column>
                            <el-table-column prop="jindu" label="材料名称" >
...
export default {
    ...
    axios.post('/api/save/guanli2', { "iddd": this.namee }, {
              headers: {
  ...
  beforeDestroy() {
    ...
    console.log(this.namee)
      if (this.tableData.length > 0) {
          axios.post('/api/save/guanli22', [this.tableData,this.namee], {
              headers: {
                  'Content-Type': 'application/json',
              },
          })
