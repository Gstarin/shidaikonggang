<template>
          ...
          <Widget title="<h5>人员管理</h5>" customHeader settings close>
            ...
            <div id="table" style="width: 100%; overflow-x: auto;"  >
              <el-table :data="current"  @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="hetong" label="合同编号" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.hetong"></el-input>  
                  </template>
                </el-table-column>
             
                <el-table-column  prop="date1" label="入职日期" width="180">
                ...
                <el-table-column prop="date2" label="离职日期"  width="180">
                    <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                ...
                <el-table-column prop="states" label="状态"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.states"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="pos" label="职位"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.pos"></el-input>  
                  </template>
                </el-table-column>
                ...
                <el-table-column prop="card" label="银行卡号"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.card"></el-input>  
                  </template>
                </el-table-column>
                ...
                <el-table-column prop="lxfs" label="联系方式"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.lxfs"></el-input>  
                  </template>
                </el-table-column>

                <el-table-column prop="person" label="紧急联系人"  width="180">
                  <template slot-scope="scope">  
    ...
    export default {
      ...
      mounted() {
        axios.get('/api/data/cq11').then(response => {
      ...
      beforeDestroy() {
        axios.post('/api/save/cq11', this.tableData, {
          headers: {
