<template>
          ...
          <Widget title="<h5>车辆年审费用</h5>" customHeader settings close>
            ...
            <div id="table" style="width: 100%; overflow-x: auto;"  >
              <el-table :data="current"  @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="date1" label="年审日期"  width="180">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="date2" label="有效期至" width="180" >
                    <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                ...
                <el-table-column prop="total" label="年审费(元)"  width="180">
                  <template slot-scope="scope">  
    ...
    export default {
      ...
      mounted() {
        axios.get('/api/data/cq5').then(response => {
      ...
      beforeDestroy() {
        axios.post('/api/save/cq5', this.tableData, {
          headers: {
