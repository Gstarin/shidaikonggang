<template>
          ...
          <Widget title="<h5>收入情况</h5>" customHeader settings close>
            ...
            <div id="table" style="width: 100%; overflow-x: auto;"  >
              <el-table :data="current"  @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="date1" label="开始时间"  width="180">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="date2" label="结束时间" width="180" >
                    <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                ...
                <el-table-column prop="jzfs" label="结账方式"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.jzfs"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="jine" label="实收金额"  width="180">
                  <template slot-scope="scope">  
              ...
              <el-table  id="DisburseTable1" style="display: none;width: 100%" @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="danwei1" label="我方单位" width="150">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.danwei1"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="danwei2" label="对方单位" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.danwei2"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="date1" label="签订日期"  width="180">
                    <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                        v-model="tableData[scope.row.id-1].date1"
                ...
                <el-table-column prop="date2" label="结束日期" width="180" >
                    <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                        v-model="tableData[scope.row.id-1].date2"
                ...
                <el-table-column prop="jine" label="合同金额"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.jine"></el-input>  
                  </template>
                </el-table-column>
    ...
    export default {
      ...
      mounted() {
        axios.get('/api/data/cq10').then(response => {
      ...
      beforeDestroy() {
        axios.post('/api/save/cq10', this.tableData, {
          headers: {
