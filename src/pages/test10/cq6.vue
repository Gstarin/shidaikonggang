<template>
          ...
          <Widget title="<h5>车辆维修</h5>" customHeader settings close>
            ...
            <div id="table" style="width: 100%; overflow-x: auto;"  >
              <el-table :data="current"  @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="xm" label="维修项目" width="100">
                  <template slot-scope="scope">  
                ...
                <el-table-column prop="gongshi" label="工时费（元）"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.gonghshi"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="total" label="费用合计（元）"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.total"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="wxdw" label="维修单位"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.wxdw"></el-input>  
                  </template>
                </el-table-column>
    ...
    export default {
      ...
      mounted() {
        axios.get('/api/data/cq6').then(response => {
      ...
      beforeDestroy() {
        axios.post('/api/save/cq6', this.tableData, {
          headers: {
