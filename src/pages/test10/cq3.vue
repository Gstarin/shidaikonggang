<template>
          ...
          <Widget title="<h5>车辆保养费用</h5>" customHeader settings close>
            ...
            <div id="table" style="width: 100%; overflow-x: auto;"  >
              <el-table :data="current"  @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="car_id" label="车牌号码" width="150">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.car_id"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="car" label="车型" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.car"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="miles1" label="上次保养里程" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.miles1"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column  prop="date1" label="上次保养日期" width="180">
                    
                  <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                        v-model="tableData[scope.row.id-1].date1"
                        type="date"
                        placeholder="选择日期">
                      </el-date-picker>
                    </div>
                ...
                <el-table-column prop="miles2" label="本次保养里程" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.miles2"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="date2" label="本次保养日期"  width="180">
                    <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                        v-model="tableData[scope.row.id-1].date2"
                        type="date"
                        placeholder="选择日期">
                      </el-date-picker>
                    </div>
                ...
                <el-table-column prop="xm" label="保养项目"  width="180">
                  <template slot-scope="scope">  
                ...
                <el-table-column prop="jine" label="金额（元）"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.jine"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="total" label="费用合计"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.total"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="person" label="维保人"  width="180">
                  <template slot-scope="scope">  
              ...
              <el-table  id="DisburseTable1" style="display: none;width: 100%" @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="car_id" label="车牌号码" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.car_id"></el-input>  
                  </template>
                </el-table-column>
                ...
                <el-table-column prop="miles2" label="本次保养里程" width="120">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.miles2"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="date2" label="本次保养日期">
                    <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                        v-model="tableData[scope.row.id-1].date2"
                ...
                <el-table-column prop="xm" label="保养项目">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.xm"></el-input>  
                  </template>
                </el-table-column>
                ...
                <el-table-column prop="total" label="费用合计">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.total"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="person" label="维保人">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.person"></el-input>  
                  </template>
                </el-table-column>
    ...
    export default {
      ...
      mounted() {
        axios.get('/api/data/cq3').then(response => {
      ...
      beforeDestroy() {
        axios.post('/api/save/cq3', this.tableData, {
          headers: {
      ...
      computed: {
        filteredItems() {
          ...
          for(i=0;i<this.tableData.length;i++)
          {
            ...
            const datee = new Date(this.tableData[i].date2); 
