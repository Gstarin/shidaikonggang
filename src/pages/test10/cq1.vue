<template>
      ...
      <b-row>
        <b-col>
          <Widget title="<h5>加油费用</h5>" customHeader settings close>
            ...
            <div id="table">
              <el-table :data="current" style="width: 100%" @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="date" label="日期" width="180">
                  <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                        v-model="tableData[scope.row.id-1].date"
                        type="date"
                        placeholder="选择日期">
                      </el-date-picker>
                    </div>
                ...
                <el-table-column prop="car_number" label="车辆号码" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.car_number"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="miles" label="当前里程数" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.miles"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column  prop="youpin" label="油品" width="180">
                    <template slot-scope="scope">  
                    <el-input v-model="scope.row.youpin"></el-input>  
                  </template>
                </el-table-column>
                ...
                <el-table-column prop="jyss" label="加油升数">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.jyss"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="money" label="加油金额（元）">
                  <template slot-scope="scope">  
    ...
    export default {
      ...
      mounted() {
        axios.get('/api/data/cq1').then(response => {
      ...
      computed: {
        filteredItems() {
          ...
          for(i=0;i<this.tableData.length;i++)
          {
            ...
            const datee = new Date(this.tableData[i].date); 
