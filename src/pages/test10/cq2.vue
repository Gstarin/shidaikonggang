<template>
          ...
          <Widget title="<h5>用电费用</h5>" customHeader settings close>
            ...
            <div id="table">
              <el-table :data="current" style="width: 100%" @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="bumen" label="用电部门">
                  <template slot-scope="scope">  
                ...
                <el-table-column prop="elec" label="总用电量">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.elec"></el-input>  
                  </template>
                </el-table-column>
              ...
              <el-table  id="DisburseTable1" style="display: none;width: 100%" @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="bumen" label="用电部门" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.bumen"></el-input>  
                  </template>
                </el-table-column>
                ...
                <el-table-column prop="elec" label="总用电量" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.elec"></el-input>  
                  </template>
                </el-table-column>
    ...
    export default {
      ...
      mounted() {
        axios.get('/api/data/cq2').then(response => {
      ...
      beforeDestroy() {
        axios.post('/api/save/cq2', this.tableData, {
          headers: {
