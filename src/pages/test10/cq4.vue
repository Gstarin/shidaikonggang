<template>
          ...
          <Widget title="<h5>车辆保险费用</h5>" customHeader settings close>
            ...
            <div id="table" style="width: 100%; overflow-x: auto;"  >
              <el-table :data="current"  @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="car" label="车辆类型" width="150">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.car"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="car_id" label="车牌号" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.car_id"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="jq" label="交强" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.jq"></el-input>  
                  </template>
                </el-table-column>
               
                <el-table-column prop="syx" label="商业险" width="100">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.syx"></el-input>  
                  </template>
                </el-table-column>
             
                <el-table-column prop="ccs" label="车船税"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.ccs"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="zbf" label="总保费"  width="180">
                  <template slot-scope="scope">  
                    <el-input v-model="scope.row.quantity"></el-input>  
                  </template>
                </el-table-column>
                <el-table-column prop="date" label="保险日期"  >
                    <template slot-scope="scope">
              ...
              <el-table  id="DisburseTable1" style="display: none;width: 100%" @cell-dblclick="handleCellDblclick"  @selection-change="handleSelectionChange" class="custom-table">
                ...
                <el-table-column prop="date" label="保险日期"  width="180">
                    <template slot-scope="scope">
                    <div class="button-container">  
                      <el-date-picker
                        v-model="tableData[scope.row.id-1].date"
    ...
    export default {
      ...
      mounted() {
        axios.get('/api/data/cq4').then(response => {
      ...
      beforeDestroy() {
        axios.post('/api/save/cq4', this.tableData, {
          headers: {
